    ...
    <div class="data-scrollbar" data-scroll="1">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                @can('permisos')   
                    <li class="@if($sel == "inventario") active @endif">
                        <a href={{ route('inventario') }} class="svg-icon">                        
                    ...
                    <li class="@if($sel == "producto") active @endif">
                        <a href={{route('producto.index')}} class="svg-icon">                        
                ...
                @endcan                    
                @can('admin')  
                    <li class="@if($sel == "categoria") active @endif">
                ...
                @endcan
                <li class="@if($sel == "paquete") active @endif">
                    <a href={{route('paquete.index')}} class="svg-icon">                        
                        <svg class="svg-icon" id="p-dash14" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect>
                        </svg>
                ...
                <li class="@if($sel == "evento") active @endif">
                    <a href="
                    @can('permisos')
                        {{route('evento.index')}} 
                    @else
                    ...
                    @endcan   
                     " class="svg-icon">                        
                        <svg class="svg-icon" id="p-dash9" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><rect x="7" y="9" width="3" height="9"></rect><rect x="14" y="13" width="3" height="5"></rect>
                        </svg>
                        <span class="ml-4">Eventos</span>
                    </a>
                </li> 
                @can('permisos')   
                    <li class="@if($sel == "evento_foto") active @endif">
                        <a href={{route('eventofoto.index')}} class="svg-icon">                        
                            <svg class="svg-icon" id="p-dash9" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><rect x="7" y="7" width="3" height="9"></rect><rect x="14" y="7" width="3" height="5"></rect>
                            </svg>
                            <span class="ml-4">Eventos Muestra</span>
                        </a>
                    </li>               
                    <li class="@if($sel == "mesero") active @endif">
                        <a href={{route('mesero.index')}} class="svg-icon">                        
                    ...
                    <li class="@if($sel == "archivo") active @endif">
                        <a href={{route('archivo.index')}} class="svg-icon">                        
                ...
                @endcan 
                @can('admin')
                    <li class="@if($sel == "user") active @endif">
